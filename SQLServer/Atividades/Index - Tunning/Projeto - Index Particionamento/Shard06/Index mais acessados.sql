...
CREATE NONCLUSTERED INDEX [IX_Oportunidade_Suspenso] ON [dbo].[Oportunidade] ([Suspenso] ASC, [ID_Funil] ASC)  INCLUDE (ID_Cliente, ID_ClientePloomes) WITH (FILLFACTOR = 100) ON [INDEX_04];  ;  ;  ;  
CREATE NONCLUSTERED INDEX [IX_Oportunidade_Suspenso2] ON [dbo].[Oportunidade] ([Suspenso] ASC, [ID_Funil] ASC)  INCLUDE (ID_Cliente, ID_ClientePloomes, ID_Responsavel) WITH (FILLFACTOR = 100) ON [INDEX_04];  ;  ;  ;  
CREATE NONCLUSTERED INDEX [IX_Oportunidade_Suspenso3] ON [dbo].[Oportunidade] ([Suspenso] ASC, [ID_Funil] ASC, [ID_Status2] ASC)  INCLUDE (ID_Cliente, ID_ClientePloomes, ID_Responsavel) WITH (FILLFACTOR = 100) ON [INDEX_04];  ;  ;  ;  
...
CREATE NONCLUSTERED INDEX [IX_Tarefa_Conclusao_ID_ClientePloomes] ON [dbo].[Tarefa_Conclusao] ([ID_ClientePloomes] ASC)  INCLUDE (Concluido, DataRecorrencia, ID, ID_Cliente, ID_Oportunidade, ID_Responsavel, ID_Tarefa, ID_TipoResponsavel, OriginTaskId, Pending) WITH (FILLFACTOR = 100) ON [INDEX_04];  ;  ;  ;  
CREATE NONCLUSTERED INDEX [IX_Tarefa_Conclusao_ID_ClientePloomes2] ON [dbo].[Tarefa_Conclusao] ([Concluido] ASC, [ID_ClientePloomes] ASC)  INCLUDE (DataRecorrencia, ID, ID_Cliente, ID_Oportunidade, ID_Responsavel, ID_Tarefa, ID_TipoResponsavel, OriginTaskId, Pending) WITH (FILLFACTOR = 100) ON [INDEX_04];  ;  ;  ;  

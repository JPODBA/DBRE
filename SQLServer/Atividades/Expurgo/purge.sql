...
DECLARE @AccountId INT = 1
 DROP TABLE IF EXISTS #TempUsuario_PromoterScore_Reason
                            ...
                            SELECT  [UPR].Id
                            FROM [Usuario_PromoterScore_Reason] UPR INNER JOIN [Usuario_PromoterScore] UP ON UPR.[PromoterScoreId] = UP.[Id] INNER JOIN [Usuario] U ON UP.[UserId] = U.[ID]

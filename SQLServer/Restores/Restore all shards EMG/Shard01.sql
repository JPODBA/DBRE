...
FROM 
  URL = N'https://stsqlprdbr02.blob.core.windows.net/bkfullsqlprd02/Ploomes_CRM_2024_02_25_11:00_part1.bak',
  URL = N'https://stsqlprdbr02.blob.core.windows.net/bkfullsqlprd02/Ploomes_CRM_2024_02_25_11:00_part2.bak',
  URL = N'https://stsqlprdbr02.blob.core.windows.net/bkfullsqlprd02/Ploomes_CRM_2024_02_25_11:00_part3.bak',
  URL = N'https://stsqlprdbr02.blob.core.windows.net/bkfullsqlprd02/Ploomes_CRM_2024_02_25_11:00_part4.bak',
  URL = N'https://stsqlprdbr02.blob.core.windows.net/bkfullsqlprd02/Ploomes_CRM_2024_02_25_11:00_part5.bak'
WITH NORECOVERY,
...
RESTORE DATABASE Shard01 --new database name
FROM 
  URL = N'https://stsqlprdbr02.blob.core.windows.net/bkdiferencialsqlprd02/Ploomes_CRM_2024_02_29_06:00_part1.bak',
  URL = N'https://stsqlprdbr02.blob.core.windows.net/bkdiferencialsqlprd02/Ploomes_CRM_2024_02_29_06:00_part2.bak'
WITH RECOVERY,
Move 'PloomesCRM'		        to 'F:\Shard01\Ploomes_CRM.mdf',
Move 'PloomesCRM_log'       to 'F:\Shard01\Ploomes_CRM_Log.ldf',
Move 'Ploomes_CRM_INDEX'    to 'F:\Shard01\Ploomes_CRM_INDEX.ndf',

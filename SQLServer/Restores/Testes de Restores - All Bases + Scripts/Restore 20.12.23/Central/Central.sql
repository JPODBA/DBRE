...
FROM URL = 'https://stsqlprdbr01.blob.core.windows.net/bkfullsqlprd01/Ploomes_CRM_2023_12_17_11:00.bak'
WITH NORECOVERY,
Move 'Ploomes_CRM'		     to 'F:\Central\Ploomes_CRM.mdf',
Move 'Ploomes_CRM_log'     to 'F:\Central\Ploomes_Log.ldf',
NOUNLOAD, REPLACE, STATS = 1
GO

RESTORE DATABASE Central --new database name
FROM URL = 'https://stsqlprdbr01.blob.core.windows.net/bkdiferencialsqlprd01/Ploomes_CRM_2023_12_20_06:00.bak'
WITH RECOVERY,
Move 'Ploomes_CRM'		     to 'F:\Central\Ploomes_CRM.mdf',
Move 'Ploomes_CRM_log'     to 'F:\Central\Ploomes_Log.ldf',
NOUNLOAD, REPLACE, STATS = 1

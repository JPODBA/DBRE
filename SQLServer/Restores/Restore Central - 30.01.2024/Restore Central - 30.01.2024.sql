...
FROM URL = 'https://stsqlprdbr01.blob.core.windows.net/bkfullsqlprd01/Ploomes_CRM_2024_01_28_11:00.bak'
WITH RECOVERY,
...
RESTORE DATABASE Central --new database name
FROM URL = 'https://stsqlprdbr01.blob.core.windows.net/bkdiferencialsqlprd01/Ploomes_CRM_2024_01_30_06:00.bak'
WITH RECOVERY,
Move 'Ploomes_CRM'		     to 'F:\Central\Ploomes_CRM.mdf',
Move 'Ploomes_CRM_log'     to 'F:\Central\Ploomes_Log.ldf',
NOUNLOAD, REPLACE, STATS = 1

/*
    Script de rollback do deployment 20-2-2024
*/
USE Ploomes_CRM;
GO
...
ALTER COLUMN [Name] [nvarchar](150) COLLATE Latin1_General_CI_AI NOT NULL 
GO

-- down 3
-- https://app.asana.com/0/626405171214145/1206511378282382/f
ALTER TABLE [Automation] 
DROP CONSTRAINT [DF_Automation_DisabledDueToError]
GO

ALTER TABLE [Automation] 
DROP COLUMN [DisabledDueToError]
GO

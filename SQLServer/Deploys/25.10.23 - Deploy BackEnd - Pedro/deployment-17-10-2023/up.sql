...
-- up 3
ALTER TABLE [dbo].[Campo] ADD [RemoveFieldHeightLimit] [bit] NOT NULL CONSTRAINT [DF_Campo_RemoveFieldHeightLimit]  DEFAULT ((0))
GO
...
SELECT F.FieldId as ID, 
       ...
       CONVERT(BIT, CASE WHEN U.ID_Perfil = 1 THEN 1
		...
		CONVERT(BIT, 0) as RemoveFieldHeightLimit,
